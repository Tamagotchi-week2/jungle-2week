...
const BACKGROUND_CRITTERS = [
  { src: '/sprites/adult/land_ab.png', style: { left: '4%', bottom: '24%', width: '58px', animationDelay: '0s' } },
  { src: '/sprites/adult/land_bb.png', style: { left: '17%', bottom: '5%', width: '50px', animationDelay: '0.4s' } },
  { src: '/sprites/adult/sea_bb.png', style: { right: '8%', bottom: '15%', width: '56px', animationDelay: '0.9s' } },
];
...
export default function AuthLayout({ children }: { children: React.ReactNode }) {
  return (
    <div
      ...
      style={{
        backgroundImage:
          "radial-gradient(circle at 50% 20%, rgba(5,5,5,0.35) 0%, rgba(5,5,5,0.75) 65%), url('/sprites/backgrounds/village-surroundings.png')",
      }}
    >
